...
$current_id = mysqli_query($con, $sql) or die("<b>Error:</b> Problem During Inserting an image<br/>" . mysqli_error($con));
if(isset($current_id)) {
...
<HTML>
<HEAD>
<TITLE>Store Your Image on a Database System - Properties: BLOB</TITLE>
