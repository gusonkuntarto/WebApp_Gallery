...
<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
    Name:<br/><input type="text" name="image_name" value="<?php echo $record['name'] ;?>"/><br/>
    Image: <br/><input type="file" name="image" value=""><br/>
<?php    
    echo '<img src="data:image/jpeg;base64,'.base64_encode( $record['data'] ).'" height="300" width="300"/>';
?>    <br/>
